...
INSERT INTO `trainer` VALUES (1, 'Kyshire', 1, 1), (2, 'MicroMice', 2, 1), (3, 'Winks', 3, 1), (4,'Neenja', 4, 2),(5, 'pkpdogg', 5, 3), (6, 'ScrewdaBlue', 5, 3);
...
INSERT INTO `offering` VALUES (1, 1), (1, 2), (2, 2);
/*!40000 ALTER TABLE `offering` ENABLE KEYS */;
UNLOCK TABLES;

DROP TABLE IF EXISTS `accepting`;
...
LOCK TABLES `accepting` WRITE;
/*!40000 ALTER TABLE `accepting` DISABLE KEYS */;
INSERT INTO `accepting` VALUES (1, 3), (2, 1), (3, 3);
/*!40000 ALTER TABLE `accepting` ENABLE KEYS */;
UNLOCK TABLES;
